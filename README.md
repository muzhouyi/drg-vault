...
可访问下方的网页版地址，或在 [Releases](https://github.com/muzhouyi/drg-vault/releases) 下载单文件网页、Windows 桌面测试版。
...
- **目录读取：**网页版可授权游戏目录，桌面版可自动查找 Steam 安装位置，直接读取当前玩家存档。
